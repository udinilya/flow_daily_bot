...
updater.dispatcher.add_handler(CommandHandler('register', bot_module.add_chat_id_in_chat_list))
updater.dispatcher.add_handler(CommandHandler('run', bot_module.get_chat_members))
updater.dispatcher.add_handler(MessageHandler(Filters.text, get_responded_members))
updater.dispatcher.add_handler(MessageHandler(Filters.text, bot_module.add_chat_id_in_list_of_responding_chats))
...
updater.job_queue.run_daily(bot_module.create_list_of_responding_chats, time=datetime.time(5, 0,
                            tzinfo=pytz.timezone('Europe/Moscow')), days=tuple(range(0, 5)))
